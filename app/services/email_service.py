...
    def __init__(self):
        # Explicitly pull the API token from your environment secrets
        resend.api_key = os.getenv("RESEND_API_KEY", "YOUR_RESEND_KEY")
        # In Sandbox mode, this MUST stay onboarding@resend.dev
...
        
        # REMOVE ALL FILTERS: Pull absolutely everything currently sitting in your cloud database tables
        results = (
...
        for scraped, curated in results[:5]:  # Take the top 5 articles to test the layout
